...
par( oma=.OMA, mar=.MAR )
.plotCatAgeBubbles( repList$ageObsProp_m1, seriesNames="Casier : Mâles", gfx=list( bygears=TRUE ) )
dev.off()

png( "plotObsAgeProp_f1.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotCatAgeBubbles( repList$ageObsProp_f1, seriesNames="Casier : Femelles", gfx=list( bygears=TRUE ) )
dev.off()

png( "plotObsAgeProp_m3.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotCatAgeBubbles( repList$ageObsProp_m2, seriesNames="Chalut : Males", gfx=list( bygears=TRUE ) )
dev.off()

png( "plotObsAgeProp_f3.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotCatAgeBubbles( repList$ageObsProp_f2, seriesNames="Chalut : Femelles", gfx=list( bygears=TRUE ) )
dev.off()


png( "plotObsAgeProp_m4.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotCatAgeBubbles( repList$ageObsProp_m3, seriesNames="Std: Mâles", gfx=list( bygears=TRUE ) )
dev.off()

png( "plotObsAgeProp_f4.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotCatAgeBubbles( repList$ageObsProp_f3, seriesNames="Std: Femelles", gfx=list( bygears=TRUE ) )
dev.off()

png( "plotObsAgeProp_m5.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotCatAgeBubbles( repList$ageObsProp_m4, seriesNames="RASC: Males", gfx=list( bygears=TRUE ) )
dev.off()

png( "plotObsAgeProp_f5.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotCatAgeBubbles( repList$ageObsProp_f4, seriesNames="RASC: Females", gfx=list( bygears=TRUE ) )
dev.off()
...
par( oma=.OMA, mar=.MAR )
.plotCatAgeFreq( repList$ageObsProp_m1, seriesNames="Casier : Mâles", gfx=list( bygears=TRUE ) )
dev.off()

png( "plotObsAgeFreq_f1.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotCatAgeFreq( repList$ageObsProp_f1, seriesNames="Casier : Femelles", gfx=list( bygears=TRUE ) )
dev.off()

png( "plotObsAgeFreq_m3.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotCatAgeFreq( repList$ageObsProp_m2, seriesNames="Chalut : Mâles", gfx=list( bygears=TRUE ) )
dev.off()

png( "plotObsAgeFreq_f3.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotCatAgeFreq( repList$ageObsProp_f2, seriesNames="Chalut : Femelles", gfx=list( bygears=TRUE ) )
dev.off()

png( "plotObsAgeFreq_m4.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotCatAgeFreq( repList$ageObsProp_m3, seriesNames="Std: Mâles", gfx=list( bygears=TRUE ) )
dev.off()

png( "plotObsAgeFreq_f4.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotCatAgeFreq( repList$ageObsProp_f3, seriesNames="Std: Femelles", gfx=list( bygears=TRUE ) )
dev.off()

png( "plotObsAgeFreq_m5.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotCatAgeFreq( repList$ageObsProp_m4, seriesNames="RASC: Mâles", gfx=list( bygears=TRUE ) )
dev.off()

png( "plotObsAgeFreq_f5.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotCatAgeFreq( repList$ageObsProp_f4, seriesNames="RASC: Femelles", gfx=list( bygears=TRUE ) )
dev.off()
...
.plotIndices( repList, seriesNames=c("Trap","Std.","RASC"),
...
.plotModCat( repList, seriesNames=c("Trap","Hook","Trawl","Std.","RASC"),
...
par( oma=.OMA, mar=.MAR )
.plotMLEageFreq( repList$ageObsProp_m1, repList$uCgta_m1, seriesNames="Casier : Mâles",
...
par( oma=.OMA, mar=.MAR )
.plotMLEageFreq( repList$ageObsProp_f1, repList$uCgta_f1, seriesNames="Casier : Femelles",
	gfx=list( annotate=TRUE, bygears=TRUE, average = FALSE ) )
dev.off()

png( "plotFitAgeFreq_m3.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotMLEageFreq( repList$ageObsProp_m2, repList$uCgta_m3, seriesNames="Chalut : Males",
  gfx=list( annotate=TRUE, bygears=TRUE, average = FALSE ) )
dev.off()

png( "plotFitAgeFreq_f3.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotMLEageFreq( repList$ageObsProp_f2, repList$uCgta_f3, seriesNames="Chalut : Femelles",
  gfx=list( annotate=TRUE, bygears=TRUE, average = FALSE ) )
dev.off()
...
par( oma=.OMA, mar=.MAR )
.plotMLEageFreq( repList$ageObsProp_m3, repList$uCgta_m4, seriesNames="Std: Mâles",
	gfx=list( annotate=TRUE, bygears=TRUE, average = FALSE ) )
dev.off()

png( "plotFitAgeFreq_f4.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotMLEageFreq( repList$ageObsProp_f3, repList$uCgta_f4, seriesNames="Std: Femelles",
	gfx=list( annotate=TRUE, bygears=TRUE, average = FALSE ) )
dev.off()

png( "plotFitAgeFreq_m5.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotMLEageFreq( repList$ageObsProp_m4, repList$uCgta_m5, seriesNames="RASC: Males",
	gfx=list( annotate=TRUE, bygears=TRUE, average = FALSE ) )
dev.off()

png( "plotFitAgeFreq_f5.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotMLEageFreq( repList$ageObsProp_f4, repList$uCgta_f5, seriesNames="RASC: Females",
	gfx=list( annotate=TRUE, bygears=TRUE, average = FALSE ) )
dev.off()
...
# Trawl
.plotMLEageFreq( repList$ageObsProp_m2, repList$uCgta_m3, seriesNames="Chalut : Mâles",
  gfx=list( annotate=TRUE, bygears=TRUE, average = TRUE ) )
# Std
.plotMLEageFreq( repList$ageObsProp_m3, repList$uCgta_m4, seriesNames="Std: Mâles",
  gfx=list( annotate=TRUE, bygears=TRUE, average = TRUE ) )
# StRS
.plotMLEageFreq( repList$ageObsProp_m4, repList$uCgta_m5, seriesNames="RASC: Mâles",
  gfx=list( annotate=TRUE, bygears=TRUE, average = TRUE ) )
...
.plotMLEageFreq( repList$ageObsProp_f3, repList$uCgta_f4, seriesNames="Std: Femelles",
  gfx=list( annotate=TRUE, bygears=TRUE, average = TRUE ) )
# StRS
.plotMLEageFreq( repList$ageObsProp_f4, repList$uCgta_f5, seriesNames="RASC: Femelles",
  gfx=list( annotate=TRUE, bygears=TRUE, average = TRUE ) )
dev.off()
...
par( oma=.OMA, mar=.MAR )
.plotMLEageResids( repList$ageObsProp_m1, repList$uCgta_m1, seriesNames="Casier : Mâles",
	gfx=list( annotate=TRUE ) )
dev.off()

png( "plotAgeResids_f1.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotMLEageResids( repList$ageObsProp_f1, repList$uCgta_f1, seriesNames="Casier : Femelles",
	gfx=list( annotate=TRUE ) )
dev.off()

png( "plotAgeResids_m3.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotMLEageResids( repList$ageObsProp_m2, repList$uCgta_m3, seriesNames="Chalut : Males",
  gfx=list( annotate=TRUE ) )
dev.off()

png( "plotAgeResids_f3.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotMLEageResids( repList$ageObsProp_f2, repList$uCgta_f3, seriesNames="Chalut : Femelles",
  gfx=list( annotate=TRUE ) )
dev.off()

png( "plotAgeResids_m4.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotMLEageResids( repList$ageObsProp_m3, repList$uCgta_m4, seriesNames="Std: Mâles",
	gfx=list( annotate=TRUE ) )
dev.off()

png( "plotAgeResids_f4.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotMLEageResids( repList$ageObsProp_f3, repList$uCgta_f4, seriesNames="Std: Femelles",
	gfx=list( annotate=TRUE ) )
dev.off()

png( "plotAgeResids_m5.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotMLEageResids( repList$ageObsProp_m4, repList$uCgta_m5, seriesNames="RASC: Males",
	gfx=list( annotate=TRUE ) )
dev.off()

png( "plotAgeResids_f5.png", width=pngWidth, height=pngHeight, pointsize=ptSize )
par( oma=.OMA, mar=.MAR )
.plotMLEageResids( repList$ageObsProp_f4, repList$uCgta_f5, seriesNames="RASC: Females",
	gfx=list( annotate=TRUE ) )
dev.off()
...
mtext( side = 4, text = "RASC", line = 1.2, font = 2 )
dev.off()
