...
plot( x = xRange, y = yRange, type = "n",
      xlab = "Longueur (cm)", ylab = "Sélectivité selon la longueur" )
  ...
  legend( x = "topright",
          legend = c( "Sélectivité en 2016 pour la pêche au chalut (normal)",
                      "Sélectivité en 2018 pour la pêche au chalut (Gamma)",
                      "Limite de taille"),
          lty = c(2,1,2),
          lwd = c(3,3,1),
          col = c("grey40","black","red"),cex=0.75)
