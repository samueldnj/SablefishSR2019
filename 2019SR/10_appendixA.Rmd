...
formulation of the ageing-error matrix from a double-geometric model 
to a discretized normal distribution. The two major differences 
between these two formulations are (i) that the error structure is constrained 
...
curve developed from commercial tagging data with 1 year at liberty. 
To improve estimates of legal and sub-legal fishing mortality from the 
...
on the selectivity-at-length curves for the trawl fleet. The
fully selected size class moved from about 42 cm to 48 cm, and the 
