...
% \newcommand{\rdYear}{2019}
% \newcommand{\rdAppMonth}{November}
% \newcommand{\rdAppDay}{4}
...
\caption{Estimated standard deviation of observed ages for the two age assignment cases considered.}\label{fig:unnamed-chunk-33}
\end{figure}
\newpage
\begin{figure}[htb]
